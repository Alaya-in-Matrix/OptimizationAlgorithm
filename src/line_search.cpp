...
LineSearch::LineSearch(ObjFunc f, ofstream& l) noexcept
    : _func(f), _log(l)
{}
Solution ExactGoldenSelectionLineSearch::search(const Solution& sol, const VectorXd& direction, double min_walk, double max_walk)
{
